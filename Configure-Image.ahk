...
Global strComputerType  ; Stores the value extracted from ComputerType Drop Down List
Global vEwareServer ; Stores the value extracted from the LPTServers array ay strLocationNumber index.
...
__main__:
{
  ...
  ;vOUPath := CreateOUPath(bIsWireless, strLocation, strComputerType) ; Creates distinguished name for OU move
  ...
  {
    Log("!! Configuration Incomplete! There were " iTotalErrors . " errors with this run.")
    SoundPlay *16
  ...
  {
    Log("== Configuration Complete! There were " iTotalErrors . " errors with this program.")
