...
__main__:
{
	...
	Command("powershell.exe -NoExit -Command $pass = ***REMOVED***; $mycred = new-object -typename System.Management.Automation.PSCredential -argumentlist unattend,$pass; Add-Computer -DomainName dcls.org -Credential $mycred -Force -OUPath "vDistiguishedName) ; Join domain, Move OU.
