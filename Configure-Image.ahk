...
__main__:
{
	...
	if(vWireless == 1) ; If wireless, install wireless profile and Spiceworks.
	{
		...
		Command("msiexec.exe /I "A_ScriptDir . "_Spiceworks.msi SPICEWORKS_SERVER=spiceworks.dcls.org SPICEWORKS_AUTH_KEY= eb7e922f71BB336280238a02c02c64ac35941be2b SPICEWORKS_PORT=443 /quiet /norestart /log "A_ScriptDir . "spiceworks_install.log")
	}
